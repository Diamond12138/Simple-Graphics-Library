...
public class Camera {
    ...
    public Camera update() {
        if (Float.isNaN(mPosition.x) || Float.isInfinite(mPosition.x)) {
            mPosition.x = 0;
        }
        if (Float.isNaN(mPosition.y) || Float.isInfinite(mPosition.y)) {
            mPosition.y = 0;
        }
        if (Float.isNaN(mPosition.z) || Float.isInfinite(mPosition.z)) {
            mPosition.z = 0;
        }

        if (Float.isNaN(mCenter.x) || Float.isInfinite(mCenter.x)) {
            mCenter.x = 0;
        }
        if (Float.isNaN(mCenter.y) || Float.isInfinite(mCenter.x)) {
            mCenter.y = 0;
        }
        if (Float.isNaN(mCenter.z) || Float.isInfinite(mCenter.x)) {
            mCenter.z = 0;
        }

        if (Float.isNaN(mUp.x) || Float.isInfinite(mUp.x)) {
            mUp.x = 0;
        }
        if (Float.isNaN(mUp.y) || Float.isInfinite(mUp.x)) {
            mUp.y = 0;
        }
        if (Float.isNaN(mUp.z) || Float.isInfinite(mUp.x)) {
            mUp.z = 0;
        }
    ...
    public Camera setFovy(float value) {
        mFovy = value;
        updatePerspective();
        return this;
    }
    ...
    public Camera setAspect(float value) {
        mAspect = value;
        updatePerspective();
        return this;
    }
    ...
    public Camera setNear(float value) {
        mNear = value;
        updatePerspective();
        return this;
    }
    ...
    public Camera setFar(float value) {
        mFar = value;
        updatePerspective();
        return this;
    }
